...
<footer>
    <h1 class="footerTextGreen footer-name">RUDOLF STEINERSKOLAN</h1>
    <div class="contact">
        <ul class="footer-adress">
            <li class="footerTextGreen"><b>Adress</b></li>
            <li>Rudolf Steinerskolan i Göteborg</li>
            <li>Tallhöjdsgatan 1</li>
            <li>416 74 GÖTEBORG</li>
        </ul>
        <ul class="footer-email">
            <li class="footerTextGreen"><b>E-post</b></li>
            <li>rudolf@steinerskolan.se</li>
        </ul>
        <ul class="footer-phone">
            <li class="footerTextGreen"><b>Telefon</b></li>
            <li>031-21 46 32</li>
        </ul>
    </div>
    <div class="bottom">
