...
<header>
    <nav class="bg-blue-900 flex items-center justify-between flex-wrap p-6">
...
<!-- Hamburger icon. -->
  ...
  <div class="w-full block flex-grow lg:flex lg:items-center lg:w-auto">
    ...
    <?php foreach ($menuItems as $menuItem) : ?>
      <a href="<?= $menuItem->url; ?>" class="block mt-4 lg:inline-block lg:mt-0 text-white hover:text-red-100 mr-4">
        <?= $menuItem->title; ?>
      </a>
    <?php endforeach; ?>
    </div>
